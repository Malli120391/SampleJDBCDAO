...
public class StudentJDBCDAO {
	...
	public void add(Bean studentBean) {
		try {
			String queryString = "INSERT INTO studentdemo(RollNo, Name, Course, Address) VALUES(?,?,?,?)";
	...
	public void update(Bean studentBean) {

		try {
			String queryString = "UPDATE studentdenmo SET Name=? WHERE RollNo=?";
			connection = getConnection();
			ptmt = connection.prepareStatement(queryString);
	...
	public void delete(int rollNo) {
		...
		try {
			String queryString = "DELETE FROM studentdemo WHERE RollNo=?";
			connection = getConnection();
			ptmt = connection.prepareStatement(queryString);
	...
	public void findAll() {
		try {
			String queryString = "SELECT * FROM studentdemo";
			connection = getConnection();
			ptmt = connection.prepareStatement(queryString);
